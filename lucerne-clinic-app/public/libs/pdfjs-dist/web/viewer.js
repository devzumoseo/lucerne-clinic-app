...
class AnnotationEditorParams {
  ...
  #bindListeners({
    ...
    editorFreeTextFontSize.addEventListener("input", function () {
      ...
      const inputElement = document.getElementById('editorFreeTextFontSize1');
      if (inputElement) {inputElement.value = this.valueAsNumber;}
    });
    editorFreeTextFontSize1.addEventListener("input", function () {
      dispatchEvent("FREETEXT_SIZE", this.valueAsNumber);
      const inputElement = document.getElementById('editorFreeTextFontSize');
      if (inputElement) {inputElement.value = this.valueAsNumber;}
    });
    ...
    editorInkThickness.addEventListener("input", function () {
      ...
      const inputElement = document.getElementById('editorInkThickness1');
      if (inputElement) {inputElement.value = this.valueAsNumber;}
    });
    editorInkThickness1.addEventListener("input", function () {
      dispatchEvent("INK_THICKNESS", this.valueAsNumber);

      const inputElement = document.getElementById('editorInkThickness');
      if (inputElement) {inputElement.value = this.valueAsNumber;}
    });
      ...
      for (const [type, value] of evt.details) {
        switch (type) {
          case _pdfjsLib.AnnotationEditorParamsType.FREETEXT_SIZE:
            ...
            editorFreeTextFontSize1.value = value;
            break;
          ...
          case _pdfjsLib.AnnotationEditorParamsType.INK_THICKNESS:
            ...
            editorInkThickness1.value = value;
            break;
...
function download(blobUrl, filename) {
  parent.postMessage({type: 'send', value: blobUrl}, '*');
  return;
...
function getViewerConfiguration() {
  return {
    ...
    annotationEditorParams: {
      ...
      editorFreeTextFontSize1: document.getElementById("editorFreeTextFontSize1"),
      editorFreeTextColor: document.getElementById("editorFreeTextColor"),
      editorInkColor: document.getElementById("editorInkColor"),
      editorInkThickness: document.getElementById("editorInkThickness"),
      editorInkThickness1: document.getElementById("editorInkThickness1"),
